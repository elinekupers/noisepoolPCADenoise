function plotbbSNR(results,badChannels,whichbeta,whichfit,fH)
...
subplot(1,2,1);
megPlotMap(ab_snr1a,clims_ab,fH,'jet','SNR of Broad Band Signal: Original');
subplot(1,2,2);
megPlotMap(ab_snr2a,clims_ab,fH,'jet','SNR of Broad Band Signal: Denoised');