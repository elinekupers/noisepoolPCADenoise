...
fH1 = figure('position',[1,600,1400,800]); set(gcf, 'Name', 'SF5, Individual subjects BB Post denoising', 'NumberTitle', 'off');
...
if saveFigures
    ...
    hgexport(fH1, fullfile(figureDir, sprintf('S5_individualsubject_thresh%d', threshold)));
end
