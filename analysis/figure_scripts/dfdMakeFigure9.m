...
%% Function to reproduce Figure 9 (Spatialmap) for pre vs post denoising broadband responses
%
% dfdMakeFigure9()
%
...
figure('position',[1,600,2000,300], 'Name', 'Figure 9', 'NumberTitle', 'off');
...
if saveFigures
    figurewrite(fullfile(figureDir,'figure9ab_BeforeAfter'),[],0,'.',1);
end
