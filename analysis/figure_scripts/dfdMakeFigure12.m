...
dfdMakeFigure12AcrossSubjects(whichSubjectsRaw,figureDir,dataDir,saveFigures,threshold)


%% Get denoising results for tsss data
whichSubjectsTSSS   = [14,16,18,20];       % TSSS
dfdMakeFigure12AcrossSubjects(whichSubjectsTSSS,figureDir,dataDir,saveFigures,threshold)
