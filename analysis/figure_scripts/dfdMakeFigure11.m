...
%% Function to reproduce Figure 11 (Spatialmap) across NYU dataset subjects having no, CALM or TSPCA preprocessing
%
% dfdMakeFigure11()
%
...
meshData([1 2 5]) = dfdMakeFigure11AcrossSubjects(whichSubjectsRaw,figureDir,dataDir,saveFigures,threshold);

%% Get denoising results for CALM preprocessed data
% Makes columns 3,6
whichSubjectsCALM   = 21:28;              % CALM
meshData([1 3 6]) = dfdMakeFigure11AcrossSubjects(whichSubjectsCALM,figureDir,dataDir,saveFigures,threshold);

%% Get denoising results for TSPCA preprocessed data
% Makes columns 4,7
whichSubjectsTSPCA  = 29:36;              % TSPCA
meshData([1 4 7]) =  dfdMakeFigure11AcrossSubjects(whichSubjectsTSPCA,figureDir,dataDir,saveFigures,threshold);
...
if saveFigures
    figurewrite(fullfile(figureDir,'figure11b_bargraphCALMTSPCA'),[],0,'.',1);
end