function nppDenoiseNPCvsNoisepool(whichSubjects)
...
for whichSubject = whichSubjects
    ...
    tmp = load(sprintf(fullfile(nppRootPath, 'analysis', 'data', 's0%d_sensorData.mat'),whichSubject)); sensorData = tmp.sensorData;
    tmp = load(sprintf(fullfile(nppRootPath, 'analysis', 'data', 's0%d_conditions.mat'),whichSubject)); conditions = tmp.conditions;
    ...
    fname     = sprintf(fullfile(nppRootPath,'analysis','data', ['s0%d_denoisedData_NCPSvsNoisePool']), whichSubject);
