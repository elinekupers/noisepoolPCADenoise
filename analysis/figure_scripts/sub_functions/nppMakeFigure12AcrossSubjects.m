function data = nppMakeFigure12AcrossSubjects(whichSubjects,figureDir,dataDir,saveFigures,threshold)
%% Function to reproduce Figure 12 (Spatialmap) across NYU dataset subjects having no, CALM or TSPCA preprocessing
%
% data = nppMakeFigure12AcrossSubjects(whichSubjects,figureDir,dataDir,saveFigures,threshold)
%
% INPUTS:
