...
meshData([1 2 4])     = nppMakeFigure13AcrossSubjects(whichSubjectsRaw,figureDir,dataDir,saveFigures,threshold);


%% Get denoising results for tsss data
whichSubjectsTSSS   = [14,16,18,20];       % TSSS
meshData([1 3 5])     = nppMakeFigure13AcrossSubjects(whichSubjectsTSSS,figureDir,dataDir,saveFigures,threshold);
...
types = {'Raw','TSSS','Noisepool-PCA','Noisepool-PCA + TSSS'}; %
