...
[data,design,exampleIndex,exampleChannel] = prepareData(dataDir,whichSubject,2);
...
% Print
if saveFigures
    figurewrite(fullfile(figureDir, 'figure16A_ts'),[],0,'.',1);
end
...
% Print
if saveFigures
    figurewrite(fullfile(figureDir, 'figure16B_spec'),[],0,'.',1);
end
...
if saveFigures
    figurewrite(fullfile(figureDir, 'figure16C_sl'),[],0,'.',1);
end
...
if saveFigures
    figurewrite(fullfile(figureDir, 'figure16D_design'),[],-1,'.',1);
end
...
if saveFigures
    figurewrite(fullfile(figureDir, 'figure16E_beta'),[],0,'.',1);
end