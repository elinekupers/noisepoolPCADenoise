...
%% Function to reproduce Supplementary Figure 2 (Spatialmap)
%
% dfdMakeFigureS2()
%
...
fH1 = figure('position',[1,600,1400,800]); set(gcf, 'Name', 'S2A, Individual subjects SL', 'NumberTitle', 'off');
fH2 = figure('position',[1,600,1400,800]); set(gcf, 'Name', 'S2B, Individual subjects BB Pre denoising', 'NumberTitle', 'off');
...
if saveFigures
    ...
    hgexport(fH1,fullfile(figureDir, sprintf('S2A_individual_thresh%d', threshold)));
    hgexport(fH2,fullfile(figureDir, sprintf('S2B_individual_thresh%d', threshold)));
