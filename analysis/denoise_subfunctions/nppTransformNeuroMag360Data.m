...
%% Define directories
figureDir       = fullfile(nppRootPath, 'exampleAnalysis', 'figures_rm1epoch'); % Where to save images?
dataDir         = fullfile(nppRootPath, 'exampleAnalysis', 'data'); 

% Define paths and choose your options
whichSubject = 7; % CiNet Subject number
nppSubject   = 8 + whichSubject; % npp Subject nr
...
save(fullfile(dataDir, sprintf('s%02d_sensorData.mat',nppSubject+4)),'sensorData');
save(fullfile(dataDir, sprintf('s%02d_conditions.mat',nppSubject+4)),'conditions');
