...
% ISSUE. DOI.)
%
% Sample datasets can either be raw or denoised. The most current version
% of the denoised data sets is version 2, for raw and supplementary figures
% 1-4, version 1 is the current version. This function will automatically
% download the latest version for each dataset from the Open Science
% Framework website.
%
% The denoised datasets in an earlier version of the algorithm were first
% uploaded and computed with a summary metric definition of SNR that
% is different from the published paper. SNR_old = mean across bootstraps
% / half of 68% CI across bootstraps.
%
% Latest denoised datasets are computed with a summary metric definition
% of SNR = mean of data / std across bootstraps, as in the paper.
% 
% 
...
%                   choose: {'raw' 'denoised 10 pcs' 'denoised all pcs'
%                   'controls'} [default='raw']
%
% OUTPUTS:
% -----------------
