...
if ~isempty(sessionNums_tmp_BB)
    ...
    resultsBB        = DFDDenoiseWrapper(sessionNums_tmp_BB, [], [], doHpc, [], [], ...
...
DFDfigurespatialmap(9, sessionNums, conditionNumbers,inputDataDir, fitDataStrBB, whichFun, figureDir,saveFigures);
