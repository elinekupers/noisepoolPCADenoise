...
% fitDataStr     = 'b2fr_hpf2_fit10p1k'; % Not yet used, but might want to define later.. this string is needed to get the correct saved beta values
...
%% Make figure
DFDfiguresnrVpcs(sessionNums, plotBb, inputDataDir, whichFun, figureDir, saveFigures)